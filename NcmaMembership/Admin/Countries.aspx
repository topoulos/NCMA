<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Countries.aspx.cs" Inherits="NcmaMembership.Countries" %>
...
<asp:Content 
    ...
    <dx:ASPxGridView 
        ...
        <dx:GridViewDataTextColumn Caption="Country Name" FieldName="Name" 
            VisibleIndex="2">
        </dx:GridViewDataTextColumn>
    </Columns>
    <Settings ShowFilterRow="True" />
</dx:ASPxGridView>
<asp:EntityDataSource ID="edCountries" runat="server" 
