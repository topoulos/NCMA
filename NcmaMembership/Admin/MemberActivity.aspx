    ...
    <dx:ASPxGridView 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn 
                FieldName="ID" 
                VisibleIndex="0" 
                Settings-AutoFilterCondition="Contains" ReadOnly="True" Visible="False">
<Settings AutoFilterCondition="Contains"></Settings>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataComboBoxColumn Caption="Activity Type" 
            FieldName="TypeID" VisibleIndex="1">
            <PropertiesComboBox DataSourceID="edMemberActivityType" EnableFocusedStyle="False" 
                TextField="Description" ValueField="ID">
            </PropertiesComboBox>
        </dx:GridViewDataComboBoxColumn>
	    
        <dx:GridViewDataDateColumn FieldName="ActivityDate" VisibleIndex="2" Caption="Date">
...
<Settings AutoFilterCondition="Contains"></Settings>
            ...
            <dx:GridViewDataMemoColumn FieldName="ActivityDescription" VisibleIndex="4">
    ...
    <asp:EntityDataSource 
        ...
        EnableInsert="True" 
        EnableUpdate="True" 
        EntitySetName="memberactivities">
    </asp:EntityDataSource>    
    <asp:EntityDataSource 
        ID="edMemberActivityType" 
        runat="server" 
        ConnectionString="name=MyNcmaEntities" 
        DefaultContainerName="MyNcmaEntities" 
        ContextTypeName="NcmaMembership.MyNcmaEntities" 
        ...
        EnableInsert="True" 
        EnableUpdate="True" 
        EntitySetName="memberactivitytypes">
    </asp:EntityDataSource>
